...
class PublishingTestCase(TestCase):
    ...
    def test_misp_publishing(self, _, stix_version):
        ...
        with open((stix_filename), 'r') as stix_f:
            stix_io = six.StringIO(stix_f.read())
        ...
        httpretty.register_uri(
            ...
            body=json.dumps({"result": {
                "sane_defaults": {
                    ...
                    "malware-sample":{"default_category":"Payload delivery","to_ids":1},
                    "link":{"default_category":"External analysis","to_ids":0},
                ...
                "types":[
                    "md5","sha1","sha256","filename","pdb","filename|md5","filename|sha1","filename|sha256",
                ...
                "category_type_mappings":{
                    ...
                    "Social network":[
                        "github-username","github-repository","github-organisation","jabber-id",
                        "twitter-id","email-src","email-dst","comment","text","other","whois-registrant-email"
                    ],
                    "Person":[
                        "first-name","middle-name","last-name","date-of-birth","place-of-birth","gender",
        ...
        httpretty.register_uri(
            ...
            body=json.dumps({
                "Event": {
                    ...
                    "attribute_count": "0",
                    "analysis": misp_event_args['analysis'],
        ...
        # That is, make the HTTP requests to which httpretty will respond
        ...
        assert r_get_version.headers['authorization'] == misp_args['misp_key']
        ...
        # Check that the TLP tag is added to the event.
        r_add_tag = reqs[4]
        ...
        obs_attributes = [json.loads(request.body.decode('utf-8'))
                          for request in reqs[5:]]
